...
!(function(a) {
  ...
  (b.prototype = {
    _init : function() {
      var b = this;
      (this.phrases = []), this.element.addClass("morphext"),
    ...
    start : function() {
      var a = this;
      this._interval =
          setInterval(function() { a.animate(); }, this.settings.speed);
    },
...
a.backstretch = function(
    c, b) { return a("body").backstretch(c, b).data("backstretch"); };
a.expr[":"].backstretch = function(
    c) { return a(c).data("backstretch") !== p; };
...
q.prototype = {
  resize : function() {
    try {
      ...
      j >= g ? ((f = (j - g) / 2),
             ...
             : ((j = g), (e = j * this.$img.data("ratio")), (f = (e - b) / 2),
          ...
          a("<img />")
              ...
              .bind("load",
                    function(f) {
                      ...
                      a(this).fadeIn(
                          b.options.speed || b.options.fade, function() {
                            e.remove();
                            b.paused || b.cycle();
                            a([ "after", "show" ]).each(function() {
                              b.$container.trigger(
                                  a.Event("backstretch." + this, d), [ b, c ]);
                            });
                          });
                      b.resize();
                    })
  ...
  prev : function() {
    return this.show(0 === this.index ? this.images.length - 1
                                      : this.index - 1);
  },
  pause : function() {
    this.paused = !0;
    ...
    1 < this.images.length &&
        (clearInterval(this.interval),
         (this.interval = setInterval(
              a.proxy(function() { this.paused || this.next(); }, this),
...
l = !(((-1 < m.indexOf("iPhone") || -1 < m.indexOf("iPad") ||
        -1 < m.indexOf("iPod")) &&
       e && 534 > e) ||
      (d.operamini && "[object OperaMini]" === {}.toString.call(d.operamini)) ||
      (n && 7458 > t) || (-1 < f.indexOf("Android") && e && 533 > e) ||
      (h && 6 > h) || ("palmGetResource" in d && e && 534 > e) ||
        ...
        for (var r in t) {
          ...
          for (var a in this.waypoints[r]) {
            ...
            d.element !== d.element.window &&
                ...
                (d.triggerPoint = Math.floor(y + l - f)), (h = w < s.oldScroll),
                (p = d.triggerPoint >= s.oldScroll), (u = h && p),
                (c = !h && !p),
                !g && u
...
!(function(t, e) {
  ...
  : "object" == typeof exports ? (module.exports = e(require, exports, module))
                               : (t.Tether = e());
})(this, function(t, e, o) {
  "use strict";
  function i(t, e) {
  ...
  function n(t) {
    ...
    if (t.ownerDocument !== document) {
      ...
      if (r) {
        var s = n(r);
        (o.top += s.top), (o.bottom += s.top), (o.left += s.left),
            (o.right += s.left);
      }
    }
    return o;
  ...
  function a(t) {
    var e = void 0;
    t === document ? ((e = document), (t = document.documentElement))
                   : (e = t.ownerDocument);
    ...
    return ((i.top -= r.top), (i.left -= r.left),
            ...
            (i.top = i.top - o.clientTop), (i.left = i.left - o.clientLeft),
  ...
  function d(t, e) {
    if ("undefined" != typeof t.classList)
      e.split(" ").forEach(function(e) { e.trim() && t.classList.remove(e); });
    else {
  ...
  function p(t, e) {
    if ("undefined" != typeof t.classList)
      e.split(" ").forEach(function(e) { e.trim() && t.classList.add(e); });
    else {
      d(t, e);
      var o = c(t) + (" " + e);
      g(t, o);
  ...
  function m(t, e, o) {
    o.forEach(function(o) { e.indexOf(o) === -1 && u(t, o) && d(t, o); }),
        e.forEach(function(e) { u(t, e) || p(t, e); });
  }
  function i(t, e) {
    if (!(t instanceof e))
      throw new TypeError("Cannot call a class as a function");
  ...
  function w() {
    for (var t = {top : 0, left : 0}, e = arguments.length, o = Array(e), i = 0;
         i < e; i++)
      o[i] = arguments[i];
    return (o.forEach(function(e) {
      var o = e.top, i = e.left;
      "string" == typeof o && (o = parseFloat(o, 10)),
          "string" == typeof i && (i = parseFloat(i, 10)), (t.top += o),
          (t.left += i);
    }),
            t);
  }
  function C(t, e) {
    return ("string" == typeof t.left && t.left.indexOf("%") !== -1 &&
                (t.left = (parseFloat(t.left, 10) / 100) * e.width),
            "string" == typeof t.top && t.top.indexOf("%") !== -1 &&
    ...
    return ("scrollParent" === e
            ...
            "undefined" != typeof e.nodeType && !(function() {
              ...
              if (((e = [ i.left, i.top, o.width + i.left, o.height + i.top ]),
                ...
                (e[0] += r.pageXOffset), (e[1] += r.pageYOffset),
                    (e[2] += r.pageXOffset), (e[3] += r.pageYOffset);
              }
  ...
  var E = (function() {
    ...
    return function(e, o,
                    i) { return o && t(e.prototype, o), i && t(e, i), e; };
  })(),
      x = void 0;
  ...
  var A = null, T = (function() {
      ...
      S = {}, P = function() {
        ...
        return ("undefined" == typeof S[e] &&
                    ((S[e] = n(t)), k(function() { delete S[e]; })),
                S[e]);
      }, M = null, W = [], k = function(t) { W.push(t); }, _ = function() {
                     ...
                     [
                         ...
                         value : function(t, e, o) {
                           ...
                           "undefined" == typeof this.bindings &&
                               ...
                               this.bindings[t].push(
                                   {handler : e, ctx : o, once : i});
                         },
                       },
                       {
                         key : "once",
                         value : function(t, e, o) { this.on(t, e, o, !0); },
                       },
                       {
                         key : "off",
                         value : function(t, e) {
                       ...
                       },
                       {
                         ...
                         value : function(t) {
                           if ("undefined" != typeof this.bindings &&
                               this.bindings[t]) {
                             for (var e = 0, o = arguments.length,
                                      i = Array(o > 1 ? o - 1 : 0), n = 1;
                                  n < o; n++)
                               i[n - 1] = arguments[n];
                             for (; e < this.bindings[t].length;) {
                               var r = this.bindings[t][e], s = r.handler,
                                   a = r.ctx, f = r.once, l = a;
  ...
  var Y = x.Utils, r = Y.getScrollParents, a = Y.getBounds,
      f = Y.getOffsetParent, h = Y.extend, p = Y.addClass, d = Y.removeClass,
  ...
  !(function() {
    var t = null, e = null, o = null, i = function n() {
      return "undefined" != typeof e && e > 16
                 ...
                 : void (("undefined" != typeof t && b() - t < 10) ||
                         (null != o && (clearTimeout(o), (o = null)), (t = b()),
                          X(), (e = b() - t)));
    };
    "undefined" != typeof window &&
        "undefined" != typeof window.addEventListener && [
          "resize", "scroll", "touchmove"
        ].forEach(function(t) { window.addEventListener(t, i); });
  })();
  var F = {center : "center", left : "right", right : "left"},
      H = {middle : "middle", top : "bottom", bottom : "top"}, N = {
        top : 0,
        left : 0,
        middle : "50%",
        center : "50%",
      ...
      I = (function(t) {
        function e(t) {
          var o = this;
          i(this, e),
              j(Object.getPrototypeOf(e.prototype), "constructor", this)
                  .call(this),
              (this.position = this.position.bind(this)), D.push(this),
              (this.history = []), this.setOptions(t, !1),
              ...
              [
                ...
                },
                {
                  ...
                  value : function(t) {
                    ...
                    this.options = h(i, t);
                    var n = this.options, s = n.element, a = n.target,
                        f = n.targetModifier;
                    if (((this.element = s), (this.target = a),
                  ...
                  value : function() {
                    ...
                    if ("visible" === this.targetModifier) {
                      ...
                      return ((e.height = Math.min(
                                   e.height, t.height - (pageYOffset - t.top))),
                              (e.height = Math.min(
                                   e.height,
                              ...
                              (e.height -= 2),
                              (e.width = Math.min(
                                   e.width, t.width - (pageXOffset - t.left))),
                              (e.width = Math.min(
                                   e.width,
                                   t.width - (t.left + t.width -
                    ...
                    if ("scroll-handle" === this.targetModifier) {
                      ...
                      var i = getComputedStyle(o),
                          ...
                          r = 0;
                      n && (r = 15);
                      var s = t.height - parseFloat(i.borderTopWidth) -
                              parseFloat(i.borderBottomWidth) - r,
                          e = {
                            width : 15,
                            height : 0.975 * s * (s / o.scrollHeight),
                            left : t.left + t.width -
                                       parseFloat(i.borderLeftWidth) - 15,
                          },
                          f = 0;
                      s < 408 && this.target === document.body &&
                          (f = -11e-5 * Math.pow(s, 2) - 0.00727 * s + 22.58),
                          this.target !== document.body &&
                              (e.height = Math.max(e.height, 24));
                      var l = this.target.scrollTop / (o.scrollHeight - s);
                      return ((e.top = l * (s - e.height - f) + t.top +
                ...
                },
                {
                  ...
                  value : function(t, e) {
                    ...
                    t.top &&
                        ...
                        t.left && n.push(this.getClass("element-attached") +
                                         "-" + t.left),
                        e.top && n.push(this.getClass("target-attached") + "-" +
                                        e.top),
                        e.left && n.push(this.getClass("target-attached") +
                                         "-" + e.left);
                    var r = [];
                ...
                },
                {
                  ...
                  value : function() {
                    ...
                    if (this.enabled) {
                      ...
                      var h = this.cache(
                              "target-bounds",
                              function() { return t.getTargetBounds(); }),
                          d = h,
                      ...
                      for (var m = h.left + u.left - p.left,
                               v = h.top + u.top - p.top, y = 0;
                           y < x.modules.length; ++y) {
                        ...
                        if (O === !1)
                          return !1;
                        "undefined" != typeof O && "object" == typeof O &&
                            ((v = O.top), (m = O.left));
                      }
                      var E = {
                        page : {top : v, left : m},
                      ...
                      return (
                          ...
                          ([ "", "static" ].indexOf(A.body.style.position) !==
                               -1 &&
                           [ "", "static" ].indexOf(
                               A.body.parentElement.style.position) !== -1) ||
                          ...
                          "undefined" != typeof this.options.optimizations &&
                              ...
                              !(function() {
                                ...
                                if (([ "Top", "Left", "Bottom", "Right" ]
                                     ...
                                     (o.right = A.body.scrollWidth - o.left -
                                                n.width + r.right),
                                     (o.bottom = A.body.scrollHeight - o.top -
                                                 n.height + r.bottom),
                          ...
                          this.move(E), this.history.unshift(E),
                  ...
                  value : function(t) {
                    ...
                    if ("undefined" != typeof this.element.parentNode) {
                      ...
                      for (var i in t) {
                        o[i] = {};
                        for (var n in t[i]) {
                          for (var r = !1, s = 0; s < this.history.length;
                               ++s) {
                      ...
                      var l = {top : "", left : "", right : "", bottom : ""},
                          d = function(t, o) {
                            var i =
                                "undefined" != typeof e.options.optimizations,
                                n = i ? e.options.optimizations.gpu : null;
                            if (n !== !1) {
                              var r = void 0, s = void 0;
                              if ((t.top ? ((l.top = 0), (r = o.top))
                                         : ((l.bottom = 0), (r = -o.bottom)),
                                   t.left ? ((l.left = 0), (s = o.left))
                                          : ((l.right = 0), (s = -o.right)),
                                   window.matchMedia)) {
                                var a =
                                    window
                              ...
                              (l[L] = "translateX(" + s + "px) translateY(" +
                                      r + "px)"),
                                  "msTransform" !== L &&
                                      (l[L] += " translateZ(0)");
                            } else
                              t.top ? (l.top = o.top + "px")
                                    : (l.bottom = o.bottom + "px"),
                                  t.left ? (l.left = o.left + "px")
                                         : (l.right = o.right + "px");
                          }, p = !1;
                      if (((o.page.top || o.page.bottom) &&
                           ...
                           : "undefined" != typeof o.offset && o.offset.top &&
                                   o.offset.left
                               ? !(function() {
                                   l.position = "absolute";
                                   var i = e.cache(
                                       "target-offsetparent",
                                       function() { return f(e.target); });
                        ...
                        if (this.options.bodyElement)
                          ...
                          for (var u = !0, c = this.element.parentNode;
                          ...
                          u || (this.element.parentNode.removeChild(
                                    this.element),
  ...
  var $ = h(I, x),
      ...
      Y = x.Utils, a = Y.getBounds, h = Y.extend, m = Y.updateClasses,
      k = Y.defer, G = [ "left", "top", "right", "bottom" ];
  x.modules.push({
    position : function(t) {
      ...
      var d = this.cache("target-bounds",
                         function() { return e.getTargetBounds(); }),
          p = d.height, u = d.width,
      ...
      return (this.options.constraints.forEach(function(t) {
        ...
        ("target" !== d && "both" !== d) ||
                 ...
                 "bottom" === v.top &&
                     ("top" === y.top && o + s > b[3]
                          ...
                          : "bottom" === y.top && o < b[1] &&
                                ...
                                ((o += s - p), (v.top = "top"),
                                 (y.top = "top"))),
                 "middle" === v.top && (o + s > b[3] && "top" === y.top
                                            ? ((o -= s), (y.top = "bottom"))
                                            : o < b[1] && "bottom" === y.top &&
                                                  ((o += s), (y.top = "top")))),
            ("target" !== h && "both" !== h) ||
            ...
            "together" === h &&
                (i < b[0] && "left" === v.left
                     ? "right" === y.left
                           ? ((i += u), (v.left = "right"), (i += f),
                              (y.left = "left"))
                           : "left" === y.left && ((i += u), (v.left = "right"),
                                                   (i -= f), (y.left = "right"))
                 : i + f > b[2] && "right" === v.left
                     ? "left" === y.left
                           ? ((i -= u), (v.left = "left"), (i -= f),
                              (y.left = "right"))
                           : "right" === y.left && ((i -= u), (v.left = "left"),
                                                    (i += f), (y.left = "left"))
                     : "center" === v.left &&
                           (i + f > b[2] && "left" === y.left
                                ? ((i -= f), (y.left = "right"))
                 ...
                 i + f > b[2] &&
                     ("left" === y.left
                          ...
                          : "center" === y.left &&
                                ((i -= f / 2), (y.left = "right")))),
            "string" == typeof l
                ? (l = l.split(",").map(function(t) { return t.trim(); }))
                : l === !0 && (l = [ "top", "left", "right", "bottom" ]),
            (l = l || []);
        var w = [], C = [];
        o<b[1] && (l.indexOf("top") >= 0 ? ((o = b[1]), w.push("top"))
                                         : C.push("top")),
          o + s>b[3] &&
            (l.indexOf("bottom") >= 0 ? ((o = b[3] - s), w.push("bottom"))
                                      : C.push("bottom")),
            i<b[0] && (l.indexOf("left") >= 0 ? ((i = b[0]), w.push("left"))
                                              : C.push("left")),
              i + f>b[2] &&
                (l.indexOf("right") >= 0 ? ((i = b[2] - f), w.push("right"))
                                         : C.push("right")),
            w.length && !(function() {
              var t = void 0;
              (t = "undefined" != typeof e.options.pinnedClass
                       ...
                       : e.getClass("pinned")),
                  g.push(t), w.forEach(function(e) { g.push(t + "-" + e); });
            })(),
            C.length && !(function() {
              var t = void 0;
              (t = "undefined" != typeof e.options.outOfBoundsClass
                  ...
                  g.push(t), C.forEach(function(e) { g.push(t + "-" + e); });
            })(),
            (w.indexOf("left") >= 0 || w.indexOf("right") >= 0) &&
                (y.left = v.left = !1),
            (w.indexOf("top") >= 0 || w.indexOf("bottom") >= 0) &&
                (y.top = v.top = !1),
            (v.top === n.top && v.left === n.left &&
             y.top === e.attachment.top && y.left === e.attachment.left) ||
  ...
  x.modules.push({
    position : function(t) {
      ...
      return (
          ...
          c.forEach(function(t) { p.push(e.getClass("abutted") + "-" + t); }),
          d.length && u.push(this.getClass("abutted")),
          d.forEach(function(t) { u.push(e.getClass("abutted") + "-" + t); }),
          k(function() {
      ...
      for (var i = divisions; i >= (counter.beginAt / num) * divisions; i--) {
        ...
        if (isComma) {
          while (/(\d+)(\d{3})/.test(newNum.toString())) {
            newNum = newNum.toString().replace(/(\d+)(\d{3})/, "$1" +
                                                                   "," +
                                                                   "$2");
          }
        }
     ...
     return ((e.on = function(t, e) {
               ...
               if (i && i.length) {
                 ...
                 for (var r = this._onceEvents && this._onceEvents[t]; o;) {
                   var s = r && r[o];
                   s && (this.off(t, o), delete r[o]), o.apply(this, e),
                       (n += s ? 0 : 1), (o = i[n]);
                 }
                 return this;
               }
...
!(function(a, b) {
  "function" == typeof define && define.amd
      ? define([ "jquery" ], function(a) { return b(a); })
  ...
  !(function() {
    ...
    function b(b, d) {
      ...
      return ((this.modules = {}), (this.lGalleryOn = !1), (this.lgBusy = !1),
              ...
              this.s.dynamic               ? (this.$items = this.s.dynamicEl)
              : "this" === this.s.selector ? (this.$items = this.$el)
              : "" !== this.s.selector
                  ? this.s.selectWithin
                        ? (this.$items =
    ...
    (b.prototype.init = function() {
      ...
      c.indexOf("lg=" + this.s.galleryId) > 0 &&
          ((b.index = parseInt(c.split("&slide=")[1], 10)),
           ...
           a("body").hasClass("lg-on") ||
               (setTimeout(function() { b.build(b.index); }),
      ...
      if ((this.s.controls && this.$items.length > 1 &&
               (d = '<div class="lg-actions"><div class="lg-prev lg-icon">' +
                    this.s.prevHtml + '</div><div class="lg-next lg-icon">' +
                    this.s.nextHtml + "</div></div>"),
           ".lg-sub-html" === this.s.appendSubHtmlTo &&
               (f = '<div class="lg-sub-html"></div>'),
           (b = '<div class="lg-outer ' + this.s.addClass + " " +
                this.s.startClass +
      ...
      setTimeout(function() { a(".lg-backdrop").addClass("in"); }),
          setTimeout(function() { g.$outer.addClass("lg-visible"); },
      ...
      : c ? this.$slide.eq(b).load(c)
          ...
          "undefined" != typeof e && null !== e &&
              ("" === e ? this.$outer.find(this.s.appendSubHtmlTo)
      ...
      var p = !1;
      k.s.dynamic ? k.s.dynamicEl[b].iframe && (p = !0)
      ...
      if (!k.$slide.eq(b).hasClass("lg-loaded")) {
        if (p)
          ...
          var r = "";
          (r = q && q.youtube ? "lg-has-youtube"
               : q && q.vimeo ? "lg-has-vimeo"
                              : "lg-has-html5"),
              k.$slide.eq(b).prepend(
        ...
        if ((k.$el.trigger("onAferAppendSlide.lg", [ b ]),
             (e = k.$slide.eq(b).find(".lg-object")), i && e.attr("sizes", i),
             h)) {
          e.attr("srcset", h);
          try {
      ...
      k.$slide.eq(b)
          ...
          c === !0 &&
              (k.$slide.eq(b).hasClass("lg-complete")
                   ...
                   : k.$slide.eq(b)
                         .find(".lg-object")
                         .on("load.lg error.lg", function() { k.preload(b); }));
      ...
      if (!g.lGalleryOn || f !== b) {
        ...
        if (!g.lgBusy) {
          ...
          if ((this.$el.trigger("onBeforeSlide.lg", [ f, b, c, d ]),
               ...
               ".lg-sub-html" === this.s.appendSubHtmlTo &&
                   setTimeout(function() { g.addHtml(b); }, i),
               this.arrowDisable(b),
          ...
          g.lGalleryOn
              ? (setTimeout(function() { g.loadContent(b, !0, 0); },
                            this.s.speed + 50),
                 setTimeout(
                     function() {
                       (g.lgBusy = !1),
      ...
      this.$items.length > 1 && a(window).on("keyup.lg", function(a) {
        ...
        b.s.escKey === !0 && 27 === a.keyCode &&
            (a.preventDefault(), b.$outer.hasClass("lg-thumb-open")
      ...
      this.$outer.find(".lg-prev")
          .on("click.lg", function() { a.goToPrevSlide(); }),
          this.$outer.find(".lg-next")
              .on("click.lg", function() { a.goToNextSlide(); });
      ...
      Math.abs(d) > 15 &&
          (this.$outer.addClass("lg-dragging"),
           ...
           this.setTranslate(a(".lg-prev-slide"),
                             -this.$slide.eq(this.index).width() + d, 0),
           this.setTranslate(a(".lg-next-slide"),
                             this.$slide.eq(this.index).width() + d, 0));
      ...
      a.s.enableSwipe && a.isTouch && a.doCss() &&
          (a.$slide.on("touchstart.lg", function(c) {
            ...
            a.$outer.hasClass("lg-zoomed") ||
                (d ? ((d = !1), a.touchEnd(c - b))
                   : a.$el.trigger("onSlideClick.lg"));
          }));
    }), (b.prototype.enableDrag = function() {
      var b = this, c = 0, d = 0, e = !1, f = !1;
      b.s.enableDrag && !b.isTouch && b.doCss() &&
          (b.$slide.on("mousedown.lg", function(d) {
            b.$outer.hasClass("lg-zoomed") ||
                ((a(d.target).hasClass("lg-object") ||
                 ...
                 (d.preventDefault(),
                  b.lgBusy ||
                      (b.manageSwipeClass(), (c = d.pageX), (e = !0),
                       (b.$outer.scrollLeft += 1), (b.$outer.scrollLeft -= 1),
                       b.$outer.removeClass("lg-grab").addClass("lg-grabbing"),
                       b.$el.trigger("onDragstart.lg"))));
          }), a(window).on("mousemove.lg", function(a) {
            e && ((f = !0), (d = a.pageX), b.touchMove(c, d),
      ...
      this.$outer.find(".lg-close").on("click.lg", function() { b.destroy(); }),
          b.s.closable && (b.$outer.on("mousedown.lg", function(b) {
            c = !!(a(b.target).is(".lg-outer") || a(b.target).is(".lg-item ") ||
...
Video.prototype.init = function() {
      ...
      if (!$el.hasClass("lg-has-video")) {
        ...
        if (!$el.find(".lg-video-object").hasClass("lg-html5")) {
          ...
          $el.find(".lg-video-object")
              .on("load.lg error.lg",
                  function() { $el.addClass("lg-complete"); });
        }
      } else {
  ...
  if (_this.core.doCss() && _this.core.$items.length > 1 &&
    ...
    // For IE 9 and bellow
    _this.core.$slide.on("click.lg", function() { loadOnClick($(this)); });
  }
...
Video.prototype.loadVideo = function(src, addClass, noposter, index, html) {
  ...
  if (isVideo.youtube) {
    ...
    video =
        '<iframe class="lg-video-object lg-vimeo ' + addClass +
    ...
    video =
        '<iframe class="lg-video-object lg-dailymotion ' + addClass +
...
var inviewObjects = [], viewportSize, viewportOffset, d = document, w = window,
...
$(w).on("scroll resize scrollstop",
        function() { viewportSize = viewportOffset = null; });

// IE < 9 scrolls to focused elements without firing the "scroll" event
if (!documentElement.addEventListener && documentElement.attachEvent) {
  documentElement.attachEvent("onfocusin",
                              function() { viewportOffset = null; });
}
});
