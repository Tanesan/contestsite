...
var r = window, t = document, u = function(a, b) {
  t.addEventListener ? t.addEventListener(a, b, !1)
...
var y = /:[0-9]+$/, A = function(a, b) {
  ...
  "port" === b
      ? (a.port = String(Number(a.hostname ? a.port : r.location.port) ||
                         ("http" == a.protocol    ? 80
                          : "https" == a.protocol ? 443
                                                  : "")))
      : "host" === b && (a.hostname = (a.hostname || r.location.hostname)
                                          .replace(y, "")
                                          .toLowerCase());
  var c = z(a.protocol);
  b && (b = String(b).toLowerCase());
...
function G(a) {
  ...
  for (var b = [], c = 0; c < a.length; c += 3) {
    var d = c + 1 < a.length, f = c + 2 < a.length, e = a.charCodeAt(c),
        g = d ? a.charCodeAt(c + 1) : 0, h = f ? a.charCodeAt(c + 2) : 0,
        k = e >> 2;
    e = ((e & 3) << 4) | (g >> 4);
    g = ((g & 15) << 2) | (h >> 6);
    h &= 63;
...
var S = function(a) {
  ...
  return function(b) {
    ...
    a: {
      var f = d.split("&"); for (var e = 0; e < f.length; e++) {
        var g = f[e].split("=");
...
function W(a, b) {
  var c = "FORM" === (a.tagName || "").toUpperCase(), d = O(b, 1, c),
      f = O(b, 2, c);
  b = O(b, 3, c);
...
function X(a, b, c) {
  if (c && c.action) {
    ...
    if ("get" === d) {
      ...
      f || ((d = t.createElement("input")), d.setAttribute("type", "hidden"),
            d.setAttribute("name", a), d.setAttribute("value", b),
            c.appendChild(d));
    } else
...
var gb = Qa || "ga", jd = /^(?:utma\.)?\d+\.\d+$/, kd = /^amp-[\w.-]{22,64}$/,
    Ba = !1;
var vd = new $c();
...
ee.prototype.get = function(a) {
  return this.m.hasOwnProperty(":" + a) ? this.m[":" + a]
                                        : this.values[":" + a];
};
...
var F = window, Ea = document, G = function(a) {
  ...
  for (c = 0; c < b.length; c++) {
    ...
    e && "AMP_TOKEN" == e &&
        ((d = d.slice(1).join("=").replace(/^\s*|\s*$/g, "")) &&
...
var Ca =
  ...
  return b;
    ...
    zc =
        function(a, b, c, d, e, g, ca) {
      e = G(e)                                                       ? !1
          : eb.test(M.location.hostname) || ("/" == c && vc.test(d)) ? !1
                                                                     : !0;
      if (!e)
        return !1;
...
var oc, Id = /^.*Version\/?(\d+)[^\d].*$/i, ne = function() {
  ...
  if (void 0 === oc) {
    ...
    if (a) {
      ...
      if ((a = !(0 <= b.indexOf("Chrome")) && !(0 <= b.indexOf("CriOS")) &&
...
var Fa, Ga, fb, Ab,
    ...
    Ue = /^(?:www\.|m\.|amp\.)+/, Ub = [], da = function(a) {
      ...
      if (!ja.test(M.referrer) && "$NOT_FOUND" == c)
        return J(68), !1;
      if (void 0 !== Ab)
        return (J(56), va(function() { a(Ab); }, 0), !0);
      if (Fa)
        return Ub.push(a), !0;
      if ("$RETRIEVING" == c)
        return (J(57), va(function() { tc(a, b); }, 1e4), !0);
      Fa = !0;
      (c && "$" != c[0]) ||
      ...
      e.onload = function() {
        ...
        if (4 == e.readyState) {
          try {
            ...
            g.optOut     ? (J(63), Qc("", "$OPT_OUT", 31536e6))
            : g.clientId ? Qc(g.clientId, g.securityToken, 31536e6)
            : !c && g.alternateUrl
...
var bd = function(a) {
  return ((a                                       ? "https:"
           : Ba || "https:" == M.location.protocol ? "https:"
                                                   : "http:") +
        ...
        try {
          ...
          if (1 > ca.length)
            ...
            if ("d" == l)
              ...
              wc("https://www.google.%/ads/ga-audiences".replace("%", "com"),
                 d.google, c);
              var k = ca.substring(2);
              k && (/^[a-z.]{1,6}$/.test(k)
                        ? wc("https://www.google.%/ads/ga-audiences".replace(
                                 "%", k),
                             d.google, ua)
                        : ge("tld", "bcc", k));
            } else
  ...
  return O.navigator.sendBeacon ? O.navigator.sendBeacon(a, b) ? (c(), !0) : !1
                                : !1;
}, ge = function(a, b, c) {
  1 <= 100 * Math.random() || G("?") ||
      ((a = [ "t=error", "_e=" + a, "_v=j81", "sr=1" ]), b && a.push("_f=" + b),
       c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"),
       a.push("z=" + hd()), wc(bd(!0) + "/u/d", a.join("&"), ua));
};
var qc = function() { return (O.gaData = O.gaData || {}); }, h = function(a) {
  var b = qc();
  return (b[a] = b[a] || {});
};
...
function Sa(a) {
  ...
  default:
    b ? ((c = P(a, Ra)), (d = (d = a.Z(Ia)) || ua),
         "image" == b ? wc(e, c, d)
                      : ("xhr" == b && wd(e, c, d)) ||
                            ("beacon" == b && x(e, c, d)) || ba(e, c, d))
      : ba(e, P(a, Ra), a.Z(Ia));
  }
  e = P(a, Na);
  e = h(e);
...
var ub = S("eventCategory", "ec"), xb = S("eventAction", "ea"),
    ...
    Ve = S("l9", "_gst"), We = S("l10", "_gbt"), Xe = S("l11", "_cst"),
    Ye = S("l12", "_cbt"), Mb = S("timingCategory", "utc"),
    Nb = S("timingVar", "utv"), Ob = S("timingLabel", "utl"),
...
S("forceSSL", void 0, void 0, function() { return Ba; },
  function(a, b, c) {
    J(34);
    Ba = !!c;
  });
...
cb("\\&(.*)", function(a) {
  ...
  c && ((b.Z = function(d) { return d.get(c); }),
        (b.o = function(d, e, g, ca) { d.set(c, g, ca); }), (b.F = void 0));
  return b;
});
var Qb = T("_oot"), dd = S("previewTask"), Rb = S("checkProtocolTask"),
    ...
    n = T("clientIdTime"), xd = T("storedClientId"), Ad = S("userId", "uid"),
    Na = T("trackingId", "tid"), U = T("cookieName", void 0, "_ga"),
    W = T("cookieDomain"), Yb = T("cookiePath", void 0, "/"),
    Zb = T("cookieExpires", void 0, 63072e3),
    Hd = T("cookieUpdate", void 0, !0), Be = T("cookieFlags", void 0, ""),
    $b = T("legacyCookieDomain"), Wc = T("legacyHistoryImport", void 0, !0),
    ...
    la = T("_gcn"), Kd = T("useAmpClientId"), ce = T("_gclid"), fe = T("_gt"),
    he = T("_ge", void 0, 7776e6), ie = T("_gclsrc"),
    je = T("storeGac", void 0, !0), oe = S("_x_19"), gd = S("transportUrl"),
    Md = S("_r", "_r"), qe = S("_dp"), ad = S("_jt", void 0, "n"),
  ...
  if (!a)
    try {
      (e = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6")),
          (a = "WIN 6,0,21,0"), (e.AllowScriptAccess = "always"),
          (a = e.GetVariable("$version"));
    } catch (g) {
    }
  if (!a)
...
var aa = function(a) {
  ...
  if (Ec(b) || Fc(b)) {
    ...
    void 0 == c || Infinity == c || isNaN(c) ||
        (0 < c ? (Y(b, Gb), Y(b, Jb), Y(b, Ib), Y(b, Fb), Y(b, Hb), Y(b, Kb),
                  Y(b, Lb), Y(b, Ve), Y(b, We), Y(b, Xe), Y(b, Ye),
                  va(function() { a(b); }, 10))
               : L(O, "load", function() { gc(a); }, !1));
  }
}, Ec = function(a) {
  ...
  a[Ve] = N.L - c;
  a[We] = N.ya - c;
  O.google_tag_manager && O.google_tag_manager._li &&
...
var hc = !1, mc = function(a) {
  ...
  if (e) {
    ...
    if ("auto" != ca)
      ...
      for (var w = id(), Ce = 0; Ce < w.length; Ce++)
        if (((ca = w[Ce]), a.data.set(W, ca), (e = nd(a, b)),
             zc(c, e, g, ca, k, d, l))) {
          hc = !0;
          return;
        }
  ...
  if (a.get(Wc)) {
    ...
    d && (J(19), a.set(Tc, new Date().getTime(), !0), a.set(Rc, d.R),
  ...
  if (!a || 1 > a.length)
    ...
    for (var d = [], e = 0; e < a.length; e++) {
      ...
      ("GA1" == l || "1" == l) && 1 < ca.length
          ? ((g = ca.shift().split("-")), 1 == g.length && (g[1] = "1"),
             (g[0] *= 1), (g[1] *= 1), (ca = {H : g, s : ca.join(".")}))
  ...
  if (b && b.action)
    if ("get" == b.method.toLowerCase()) {
      ...
      for (var c = 0; c < a.length; c++) {
        ...
        ca || ((g = M.createElement("input")), g.setAttribute("type", "hidden"),
               g.setAttribute("name", d), g.setAttribute("value", e),
               b.appendChild(g));
      }
    } else
...
Dc.prototype.S = function(a, b, c) {
  function d(g) {
    try {
      g = g || O.event;
      a: {
        var ca = g.target || g.srcElement; for (g = 100; ca && 0 < g;) {
          ...
          sd(a, l.hostname || "") && l.href && (l.href = qd(e, l.href, b));
    } catch (k) {
      J(26);
    }
  }
  var e = this;
  this.target.get(Ze)
      ? De.auto(function() { return $e(e.target); }, a, b ? "fragment" : "", c)
      : (this.T ||
...
function ke(a, b) {
  return (b != Ic(a, 0) && b != Ic(a, -1) && b != Ic(a, -2) && b != pa(a, 0) &&
          b != pa(a, -1) && b != pa(a, -2));
}
function $e(a) {
  var b = af(a);
...
var fd = function(a, b) {
  ...
  if (!a.get("dcLoaded")) {
    ...
    var d;
    b[U] && (d = Cc(b[U]));
    b = new Jd(a, "https://stats.g.doubleclick.net/r/collect?t=dc&aip=1&_r=3&",
               d);
    Rd(b, a);
    a.set("dcLoaded", !0);
  }
...
var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function(a) {
        ...
        if (d && d.length)
          for (g = 0; g < d.length; g++)
            ((ca = d[g].value.split(".")), "1" != ca[0] || 3 != ca.length)
                ? c && (c.na = !0)
                : ca[1] && (e[d[g].ja] ? c && (c.pa = !0) : (e[d[g].ja] = []),
  ...
  if (a.get(Hd) && ((c = be("_ga", !!a.get(cc))), (g = be("_gl", !!a.get(cc))),
                    (d = De.get(a.get(cc))), (e = d._ga),
                    g && 0 < g.indexOf("_ga*") && !e && J(30), (g = d.gclid),
                    (ca = d._gac), c || e || g || ca))
    if ((c && e && J(36), a.get(bc) || ye(a.get(Kd)))) {
      if ((e && (J(38), a.data.set(Q, e),
                 d._gid && (J(51), a.data.set(I, d._gid))),
           g ? (J(82), a.data.set(ce, g), d.gclsrc && a.data.set(ie, d.gclsrc))
             : ca && (d = ca.split(".")) && 2 === d.length &&
        ...
        if ("1" == e) {
          ...
          d = g.indexOf("-");
          e = "";
          0 < d ? ((e = g.substring(0, d)), (d = g.substring(d + 1)))
                : (d = g.substring(1));
          if (ke(e + d, c)) {
            J(53);
            break b;
        ...
        if ((c = be("_gac", !!a.get(cc))))
          (c = c.split(".")), "1" != c[0] || 4 != c.length ? J(72)
                              : ke(c[3], c[1])             ? J(71)
                                               : (a.data.set(ce, c[3]),
  ...
  a.get(Q) ||
      ((b = (b = O.gaGlobal && O.gaGlobal.vid) && -1 != b.search(jd) ? b
                                                                     : void 0)
           ? (J(17), a.data.set(Q, b))
           : (J(8), a.data.set(Q, ra())));
  ...
  if (d && a.get(cc) && (b = M.location.hash)) {
    ...
    d = [];
    for (c = 0; c < b.length; ++c)
      (D(b[c], "utm_id") || D(b[c], "utm_campaign") || D(b[c], "utm_source") ||
...
pc.prototype.send = function(a) {
  if (!(1 > arguments.length)) {
    ...
    b && ((c = za(me[b] || [], c)), (c[Va] = b), this.b.set(c, void 0, !0),
  ...
  if (ea(a[0]))
    ...
    null != b && 4 == b.length &&
        ((this.c = b[1] || "t0"), (this.K = b[2] || ""),
         (this.methodName = b[3]), (this.a = [].slice.call(a, 1)),
         ...
         this.i && (3 <= this.a.length
                        ? ((this.X = this.a[1]), (this.W = this.a[2]))
                        : this.a[1] && (qa(this.a[1]) ? (this.X = this.a[1])
                                                      : (this.W = this.a[1]))));
    b = a[1];
    a = a[2];
    if (!this.methodName)
  ...
  if (!ea(Yd.get(b)) && !$d.get(b)) {
    ...
    if (p.test(b)) {
      ...
      G(String(a.get("trackingId"))) ||
          ((d.clientId = String(a.get(Q))), (d.ka = Number(a.get(n))),
           (c = c.palindrome ? r : q),
    ...
    if (c) {
      ...
      if (("https:" == a || a == d || ("http:" != a ? 0 : "http:" == d)) &&
          B(ca)) {
        if ((ca = ca.url))
          (a = (a = (M.querySelector && M.querySelector("script[nonce]")) ||
                    null)
                   ? a.nonce || (a.getAttribute && a.getAttribute("nonce")) ||
                         ""
                   : ""),
              e ? ((e = ""), a && Nd.test(a) && (e = ' nonce="' + a + '"'),
                   f.test(ca) && M.write("<script" + e + ' src="' + ca +
                                         '">\x3c/script>'))
                : ((e = M.createElement("script")),
                   (e.type = "text/javascript"), (e.async = !0), (e.src = ca),
